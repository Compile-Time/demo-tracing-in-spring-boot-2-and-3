...
class ImmutableAssertingSpanBuilder implements AssertingSpanBuilder {
    ...
    ImmutableAssertingSpanBuilder(final DocumentedSpan documentedSpan, final Span.Builder delegate) {
    ...
    public boolean equals(final Object o) {
        ...
        final ImmutableAssertingSpanBuilder that = (ImmutableAssertingSpanBuilder) o;
