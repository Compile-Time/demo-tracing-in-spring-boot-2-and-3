...
class ImmutableAssertingSpanCustomizer implements AssertingSpanCustomizer {
    ...
    ImmutableAssertingSpanCustomizer(final DocumentedSpan documentedSpan, final SpanCustomizer delegate) {
    ...
    public boolean equals(final Object o) {
        ...
        final ImmutableAssertingSpanCustomizer that = (ImmutableAssertingSpanCustomizer) o;
