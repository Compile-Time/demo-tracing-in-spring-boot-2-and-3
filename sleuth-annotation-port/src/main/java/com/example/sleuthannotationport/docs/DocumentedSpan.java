...
public interface DocumentedSpan {
	 ...
	 * @return wrapped span
	 */
	default AssertingSpan wrap(final Span span) {
		if (span == null) {
			return null;
	 ...
	 * @return wrapped span
	 */
	default AssertingSpanCustomizer wrap(final SpanCustomizer span) {
		if (span == null) {
			return null;
	 ...
	 * @return wrapped span
	 */
	default AssertingSpanBuilder wrap(final Span.Builder span) {
		if (span == null) {
			return null;
